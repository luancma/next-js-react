...
const Detail = ({
  post
}) => __jsx("div", null, __jsx("h1", null, post.title));

Detail.getInitialProps = async ({
  query
}) => {
  const response = await axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(`https://jsonplaceholder.typicode.com/posts/${query.postId}`);
  return {
    post: response.data
  };
};
...
module.exports = __webpack_require__(/*! C:\Users\Computador\workflow\ssr-project\pages\detail.js */"./pages/detail.js");
